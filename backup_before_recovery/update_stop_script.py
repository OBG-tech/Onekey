...
# Define content using unicode escapes for special chars to avoid encoding issues during script execution
# ? = \U0001F6D1
# ? = \u2705
# ?? = \u26A0\uFE0F
...
content_lines = [
    ...
    '',
    'echo -e "${BLUE}======================================================${NC}"',
    'echo -e "${BLUE}   \U0001F6D1  停止系统和录制                                  ${NC}"',
    'echo -e "${BLUE}======================================================${NC}"',
    'echo ""',
    '',
    '# 激活虚拟环境',
    ...
    '    fi',
    'else',
    '    echo -e "${YELLOW}\u26A0\uFE0F  没找到 service.pid，尝试杀掉所有相关进程${NC}"',
...
with open('stop_with_full_recording.sh', 'w', encoding='utf-8') as f:
    f.write('\n'.join(content_lines) + "\n")

os.chmod('stop_with_full_recording.sh', 0o755)
print("Updated stop_with_full_recording.sh")
